    ...
    return (
        <div className='grid  grid-cols-12 items-center  gap-3 mt-5 '>
            ...
            <div className='border col-span-3 font-bold text-green-600 text-lg bg-white flex justify-between items-center'>
                    <div className='hover:bg-gray-200 w-full py-[.3rem] sm:py-[.35rem] flex justify-center ' onClick={()=>{
                        removeItm(data)
                    }} >-</div>
                    <div className='px-2'>{findcount(data)}</div>
                    <div className='hover:bg-gray-200 w-full  sm:py-[.35rem] flex justify-center py-[.3rem] ' onClick={()=>{
                        addItm(data)
                    }}>+</div>

                </div>
            <div className='col-span-2 flex justify-end text-sm sm:text-base'>
                {price?price/100:199}
            </div>
        </div>
    )
