...
export default function ResMenu() {
    ...
    //             {
    //                 data[3].card.card.gridElements.infoWithStyle.offers.map((ele)=>{
    //                     return <CuponBox offer={ele.info.header} cupon={ele.info.couponCode}/>
    //                 })
    //             }
    //         </div>
    ...
    //         <div>
    //             {/* {
    //                 data[4].groupedCard.cardGroupMap.REGULAR.cards.map((item,ind)=>{
    //                     // if(ind!=0){
    //                         return <MenuSection data={item}/>
    //                     // }
    //                 })
    //             } */}
    //             <MenuSection data={data[4].groupedCard?.cardGroupMap?.REGULAR?.cards[1]}/>
    //         </div>
