    ...
    return (
        <div className='grid grid-cols-12  pl-[8%] sm:pl-[8.5%] py-[.85rem] shadow-md'>
            ...
            <div className='flex col-span-10 justify-end gap-[7%] sm:gap-[10%] items-center pr-[8%] sm:pr-[10%] '>
                <div className='flex items-center  text-sm sm:text-base hover:text-[#fb8019] cursor-pointer'><img src={require("../utils/images/search.png")} alt='logo' className='h-5 sm:h-[1.2rem]'/> <span className='pl-2 font-semibold hidden sm:inline'>Search</span></div>
